...
public final class SamodelkinDao_Impl implements SamodelkinDao {
  ...
  @Override
  public Object addCharacter(final SamodelkinCharacter samodelkinCharacter,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        ...
        try {
          __insertionAdapterOfSamodelkinCharacter.insert(samodelkinCharacter);
  ...
  @Override
  public Object deleteCharacter(final SamodelkinCharacter samodelkinCharacter,
      final Continuation<? super Unit> continuation) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __deletionAdapterOfSamodelkinCharacter.handle(samodelkinCharacter);
          __db.setTransactionSuccessful();
          return Unit.INSTANCE;
        } finally {
          __db.endTransaction();
